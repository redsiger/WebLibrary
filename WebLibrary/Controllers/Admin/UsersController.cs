...
namespace WebLibrary.Controllers.Admin
{
    public class UsersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            string RolesNameJson = JsonSerializer.Serialize(RolesNames);
            ViewData["Roles"] = RolesNameJson;
        ...
        //---------------------------------Swittch Password----------------------------
        [HttpPost]
        public async Task<IActionResult> SwitchPassword(SwitchPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                User user = await _userManager.FindByIdAsync(model.Id);
